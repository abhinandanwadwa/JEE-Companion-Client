...
const Mychallanges = () => {
  ...
  useEffect(() => {
    const getNoOfPendingReceived = async () => {
      const token = localStorage.getItem('auth-token');
      
      const response = await fetch('http://localhost:5000/api/challenge/getnoofpendingreceivedchallenges', {
        method: 'GET',
        headers:{
  ...
  return (
    ...
    <div className="container flex flex-col justify-center">
      ...
      <div className="all-challanges md:p-16 p-8 flex flex-col justify-center items-center">
        ...
        <div className="card md:w-[80%] w-[100%] bg-gray-800 rounded-2xl my-2 cursor-pointer">
